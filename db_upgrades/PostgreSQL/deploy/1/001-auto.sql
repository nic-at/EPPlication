...
-- Created on Tue Mar  5 11:01:37 2013
-- 
;
--
-- Table: role.
...
CREATE INDEX "test_idx_user_id" on "test" ("user_id");
...
;
ALTER TABLE "test" ADD CONSTRAINT "test_fk_user_id" FOREIGN KEY ("user_id")
